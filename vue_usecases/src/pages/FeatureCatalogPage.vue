...
const sections: Section[] = [
  {
    ...
    items: [
      {
        label: 'FlutterGestureDetector',
        path: '/gesture',
        desc: 'Native gesture detection with tap, pan, pinch, and rotate',
      },
  ...
  {
    title: 'Hybrid Router',
    items: [{ label: 'Routing & Navigation', path: '/routing', desc: 'Client-side routing and navigation' }],
  },
  {
